...
export default function ProductShopping() {
  const getRandomNumberSmallerThan5 = () => {
    return Math.round(Math.random() * 51) / 10;
  };
  return (
          ...
          .map((_) => (
            <div className="w-1/6  overflow-hidden  first:ml-0 last:mr-0 mx-2">
              ...
              <div className="bg-transparent mt-2">
                ...
                <p className="mb-0">iPhone 13413 Pro Max Chính Hãng VN/A</p>
                <div>
                  <Rate allowHalf defaultValue={getRandomNumberSmallerThan5()} style={{ fontSize: '12px' }} />
